...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('upiaggregation-rule-response-of-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id' => 'upiaggregation-rule-response-of-grid',
	...
	'columns' => array(
		...
		'name',
		array(
					'name' => 'requirePositionToResponse',
					'value' => '($data->requirePositionToResponse === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
		...
		array(
					'name' => 'aceptMultiple',
					'value' => '($data->aceptMultiple === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
		*/
		array(
