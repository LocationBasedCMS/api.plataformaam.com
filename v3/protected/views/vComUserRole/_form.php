...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<div class="row">
		<?php echo $form->labelEx($model,'allowedAccessPedagogicalPanel'); ?>
		<?php echo $form->checkBox($model, 'allowedAccessPedagogicalPanel'); ?>
		<?php echo $form->error($model,'allowedAccessPedagogicalPanel'); ?>
		</div><!-- row -->
		<div class="row">
		<?php echo $form->labelEx($model,'allowedAccessOnlineMap'); ?>
		<?php echo $form->checkBox($model, 'allowedAccessOnlineMap'); ?>
		<?php echo $form->error($model,'allowedAccessOnlineMap'); ?>
		</div><!-- row -->
