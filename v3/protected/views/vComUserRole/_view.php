<div class="view">
	...
	<br />
	<?php /*
	<?php echo GxHtml::encode($data->getAttributeLabel('allowedAccessPedagogicalPanel')); ?>:
	<?php echo GxHtml::encode($data->allowedAccessPedagogicalPanel); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('allowedAccessOnlineMap')); ?>:
	<?php echo GxHtml::encode($data->allowedAccessOnlineMap); ?>
	<br />
	*/ ?>
