...
abstract class BaseUPIAggregationRuleResponseOf extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'UPIAggregationRuleResponseOf|UPIAggregationRuleResponseOfs', $n);
	}
	...
	public function relations() {
		return array(
			...
			'vComUPIPublications' => array(self::HAS_MANY, 'VComUPIPublication', 'upiaggregationruleresponseof'),
		);
	}
